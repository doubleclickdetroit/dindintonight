...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MealImage'
        db.create_table('meal_images', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['meals.Meal'])),
        ...
        db.send_create_signal('meals', ['MealImage'])


    def backwards(self, orm):
        # Deleting model 'MealImage'
        db.delete_table('meal_images')
    ...
    models = {
        ...
        'meals.mealimage': {
            'Meta': {'object_name': 'MealImage', 'db_table': "'meal_images'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            'meal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['meals.Meal']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
