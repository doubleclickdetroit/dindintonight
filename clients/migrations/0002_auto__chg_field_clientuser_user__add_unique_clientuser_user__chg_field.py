...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClientUser.user'
        db.alter_column('client_users', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['users.User']))
        # Adding unique constraint on 'ClientUser', fields ['user']
        db.create_unique('client_users', ['user_id'])


        # Changing field 'ClientUser.client'
        db.alter_column('client_users', 'client_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['clients.Client']))
        # Adding unique constraint on 'ClientUser', fields ['client']
        db.create_unique('client_users', ['client_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClientUser', fields ['client']
        db.delete_unique('client_users', ['client_id'])

        # Removing unique constraint on 'ClientUser', fields ['user']
        db.delete_unique('client_users', ['user_id'])


        # Changing field 'ClientUser.user'
        db.alter_column('client_users', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'ClientUser.client'
        db.alter_column('client_users', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Client']))
    ...
    models = {
        ...
        'clients.clientuser': {
            ...
            'client': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'users'", 'unique': 'True', 'to': "orm['clients.Client']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'clients'", 'unique': 'True', 'to': "orm['users.User']"})
        },
