...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.franchise'
        db.add_column('clients', 'franchise',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='clients', to=orm['franchises.Franchise']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.franchise'
        db.delete_column('clients', 'franchise_id')
