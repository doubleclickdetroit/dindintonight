...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ClientLocationImage', fields ['client_location']
        db.delete_unique('client_location_images', ['client_location_id'])


        # Changing field 'ClientLocationImage.client_location'
        db.alter_column('client_location_images', 'client_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.ClientLocation']))

    def backwards(self, orm):

        # Changing field 'ClientLocationImage.client_location'
        db.alter_column('client_location_images', 'client_location_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['clients.ClientLocation']))
        # Adding unique constraint on 'ClientLocationImage', fields ['client_location']
        db.create_unique('client_location_images', ['client_location_id'])
    ...
    models = {
        ...
        'clients.clientlocationimage': {
            ...
            'client_location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['clients.ClientLocation']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
