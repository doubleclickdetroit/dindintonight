...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClientLocationDetail.client_location'
        db.alter_column('client_location_details', 'client_location_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['clients.ClientLocation']))
        # Adding unique constraint on 'ClientLocationDetail', fields ['client_location']
        db.create_unique('client_location_details', ['client_location_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClientLocationDetail', fields ['client_location']
        db.delete_unique('client_location_details', ['client_location_id'])


        # Changing field 'ClientLocationDetail.client_location'
        db.alter_column('client_location_details', 'client_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.ClientLocation']))
