...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientLocationImage'
        db.create_table('client_location_images', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client_location', self.gf('django.db.models.fields.related.OneToOneField')(related_name='images', unique=True, to=orm['clients.ClientLocation'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=125, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=2048, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('clients', ['ClientLocationImage'])

        # Adding field 'ClientLocationDetail.latitude'
        db.add_column('client_location_details', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=6),
                      keep_default=False)

        # Adding field 'ClientLocationDetail.longitude'
        db.add_column('client_location_details', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ClientLocationImage'
        db.delete_table('client_location_images')

        # Deleting field 'ClientLocationDetail.latitude'
        db.delete_column('client_location_details', 'latitude')

        # Deleting field 'ClientLocationDetail.longitude'
        db.delete_column('client_location_details', 'longitude')
