...
class ClientLocationDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'client_location', 'client_location_uri', 'address1', 'address2',
            'address3', 'phone_number', 'manager_name', 'resource_uri')
        read_only_fields = ('created', 'modified',)

    def get_resource_uri(self, obj):
        return reverse('api-v1-client-location-detail-detail', args=[obj.client_location.client.pk, obj.client_location.pk])
