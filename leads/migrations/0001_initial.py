...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Lead'
        db.create_table('leads', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('franchise', self.gf('django.db.models.fields.related.ForeignKey')(related_name='leads', to=orm['franchises.Franchise'])),
        ...
        db.send_create_signal('leads', ['Lead'])


    def backwards(self, orm):
        # Deleting model 'Lead'
        db.delete_table('leads')
    ...
    models = {
        ...
        'leads.lead': {
            'Meta': {'object_name': 'Lead', 'db_table': "'leads'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '255'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
            'franchise': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'leads'", 'to': "orm['franchises.Franchise']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
