...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserStripeCard.expiration_year'
        db.alter_column('user_stripe_cards', 'expiration_year', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'UserStripeCard.expiration_month'
        db.alter_column('user_stripe_cards', 'expiration_month', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'UserStripeCard.expiration_year'
        db.alter_column('user_stripe_cards', 'expiration_year', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'UserStripeCard.expiration_month'
        db.alter_column('user_stripe_cards', 'expiration_month', self.gf('django.db.models.fields.CharField')(max_length=2))
