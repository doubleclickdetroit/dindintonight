...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserStripeCustomer'
        db.create_table('user_stripe_customers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='customer', unique=True, to=orm['users.User'])),
            ('customer_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserStripeCustomer'])


    def backwards(self, orm):
        # Deleting model 'UserStripeCustomer'
        db.delete_table('user_stripe_customers')
