...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserMealPurchaseHistory.purchased_on'
        db.alter_column('user_meal_purchase_history', 'purchased_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'UserMealPurchaseHistory.purchased_on'
        db.alter_column('user_meal_purchase_history', 'purchased_on', self.gf('django.db.models.fields.DateTimeField')())
