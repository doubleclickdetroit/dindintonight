...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user_locations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', to=orm['users.User'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_locations', to=orm['locations.Location'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserLocation'])

        # Adding model 'UserMealPurchaseHistory'
        db.create_table('user_meal_purchase_history', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_meal_purchase_history', to=orm['users.User'])),
            ('meal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_meal_purchase_history', to=orm['meals.Meal'])),
            ...
            ('is_delivered', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserMealPurchaseHistory'])

        # Adding model 'UserPaymentInfo'
        db.create_table('user_payment_info', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_info', to=orm['users.User'])),
            ('card', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_payment_info', to=orm['cards.Card'])),
            ('stripe_token', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserPaymentInfo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('user_locations')

        # Deleting model 'UserMealPurchaseHistory'
        db.delete_table('user_meal_purchase_history')

        # Deleting model 'UserPaymentInfo'
        db.delete_table('user_payment_info')
