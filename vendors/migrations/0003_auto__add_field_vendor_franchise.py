...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vendor.franchise'
        db.add_column('vendors', 'franchise',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='vendors', to=orm['franchises.Franchise']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vendor.franchise'
        db.delete_column('vendors', 'franchise_id')
