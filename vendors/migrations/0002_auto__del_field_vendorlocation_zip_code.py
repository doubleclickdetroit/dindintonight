...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VendorLocation.zip_code'
        db.delete_column('vendor_locations', 'zip_code')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VendorLocation.zip_code'
        raise RuntimeError("Cannot reverse this migration. 'VendorLocation.zip_code' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'VendorLocation.zip_code'
        db.add_column('vendor_locations', 'zip_code',
